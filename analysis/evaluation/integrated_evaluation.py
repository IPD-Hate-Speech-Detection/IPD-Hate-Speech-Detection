...
def perform_integrated_analysis(english_results: Dict, 
                                ...
                                image_results: Dict,
                                audio_results: Dict,
                                video_results: Dict) -> Dict:
    
    print("Performing integrated analysis across modalities...")
    
    f1_scores = {
        "English Text": english_results["f1_score"],
        "Hinglish Text": hinglish_results.get("f1_score", hinglish_results.get("binary_classification", {}).get("f1_score", 0)),
        "Image": image_results.get("binary_classification", {}).get("f1_score", 0),
